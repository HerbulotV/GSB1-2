<?php
function creerPdf($lesFraisForfait, $lesFraisHorsForfait, $numAnnee, $numMois, $libEtat, $montantValide, $nbJustificatifs,$comptable,$visiteur){
    ...
    $pdf->Text(18,68,'Numero Fiche : B5986B');
    ...
    $pdf->Text(18,93,'Etat : '.utf8_decode($libEtat));
